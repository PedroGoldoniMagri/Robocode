//Desenvolvido por Pedro Goldoni Magri
//Desenvolvido para ser usado na competição Robocode de 2021
//Na escola Etec Lauro Gomes
...
public class LG_FERA_2021 extends AdvancedRobot
{
    ...
    public void onScannedRobot(ScannedRobotEvent e)
    {
        ...
        //Variáveis necessárioas para o que o radar possa rastrear o alvo
    ...
    private class guess_fator_targeting
    {
        public void onScannedRobot(ScannedRobotEvent e)
        {
            ...
            //move a arma para onde o inimigo pode estar no futuro
    ...
    private class GFT_tiro extends Condition
    {
        ...
        //método que calcula direção em que deve-se atirar para atingir o inimigo
